...
<html>
   <head>
      ...
      <link rel="apple-touch-icon-precomposed" href="<?php echo get_template_directory_uri(); ?>/img/icons/site-icon.png"/>
      <link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/img/icons/site-icon.png"/>
      <link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/img/icons/site-icon.png"/>
      ...
      fbq('init', '180310789026171');
      fbq('track', "PageView");</script>
      <noscript><img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=180310789026171&ev=PageView&noscript=1"
      /></noscript>
   ...
   <!-- Home page -->
      ...
      <div class="landing-section hero section big-cta" style="background-image: url(<?php the_field('hero_background_image') ?>);">
         ...
         <div class="landing-hero hero-text section-heading vAlign">
            <h1 class="clrPop">Creative Digital Agency</h1>
