...
<div id="menu" class="main-menu">
   <div id="section0" class="menu-section-1 menu-section section" data-anchor="get-to-know-us">
      <div class="menu-image" style="background-image: url(<?php the_field('section_1_image', 4); ?>);">
      </div>
   </div>

   <div id="section1"class="menu-section-2 menu-section section" data-anchor="our-strategic-vision">
      <div class="menu-image" style="background-image: url(<?php the_field('section_2_image', 4); ?>);">
      </div>
   </div>

   <div id="section2"class="menu-section-3 menu-section section" data-anchor="explore-the-latest">
      <div class="menu-image" style="background-image: url(<?php the_field('section_3_image', 4); ?>);">
      </div>
   </div>

   <div id="section3"class="menu-section-4 menu-section section" data-anchor="reach-out-to-us">
      <div class="menu-image" style="background-image: url(<?php the_field('section_4_image', 4); ?>);">
      </div>
   </div>

   <div id="section4"class="menu-section-5 menu-section section" data-anchor="lets-build-something">
